...
@section('content')
    ...
    <div class="page-title" data-aos="fade">
        <div class="container d-lg-flex justify-content-between align-items-center">
            <h1 class="mb-2 mb-lg-0">Event | <span class="text-secondary fs-6">Sedang Berlangsung</span></h1>
            <nav class="breadcrumbs">
                <ol>
                <li><a href="{{ route('home')}}" class="text-dark">Beranda</a></li>
                <li class="current text-primary">Event Sedang Berlangsung</li>
                </ol>
            </nav>
        </div>
    </div>
    ...
    <section id="team" class="team section">
        <div class="container section-title" data-aos="fade-up">
            <h2>Event</h2>
            <p><span>Event</span> <span class="description-title">Sedang Berlangsung</span></p>
        </div>
        <div class="container">
            <div class="row mb-4">
                <div class="col-md-8">
                    <div class="row">
                        <div class="col-md-7 mb-3 mb-md-0">
                            <form class="d-flex" role="search" method="GET" action="{{ route('ongoingEvent') }}">
                        ...
                        <div class="col-md-5 d-flex justify-content-md-end gap-2">
                            <form method="GET" action="{{ route('ongoingEvent') }}" class="d-flex">
                    ...
                    <div class="card p-3 shadow border-0" style="border-radius: 15px; overflow: hidden;">
                        ...
                        <div class="p-3">
                            ...
                            @else
                                ...
                                @endforeach
                                @if (count($upcomingEvent) > 5)
                                    <div class="text-center mt-5">
                                        <a href="{{ route('upcomingEvent') }}" class="btn btn-primary btn-sm">Lihat Semua Event yang Sudah Berlangsung</a>
                                    </div>
                                @endif
                            @endif
                        </div>
