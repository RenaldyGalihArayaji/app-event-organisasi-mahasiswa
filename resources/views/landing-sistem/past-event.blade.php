...
@section('content')
    ...
    <div class="page-title" data-aos="fade">
        <div class="container d-lg-flex justify-content-between align-items-center">
            <h1 class="mb-2 mb-lg-0">Event | <span class="text-secondary fs-6">Sudah Berlangsung</span></h1>
            <nav class="breadcrumbs">
                <ol>
                <li><a href="{{ route('home')}}" class="text-dark">Beranda</a></li>
                <li class="current text-primary">Event Sudah Berlangsung</li>
                </ol>
            </nav>
        </div>
    </div>
    ...
    <section id="team" class="team section">
        <div class="container section-title" data-aos="fade-up">
            <h2>Event</h2>
            <p><span>Event</span> <span class="description-title">Sudah Berlangsung</span></p>
        </div>
        <div class="container">
            <div class="row mb-4">
                <div class="col-md-8">
                    <div class="row">
                        <div class="col-md-7 mb-3 mb-md-0">
                            <form class="d-flex" role="search" method="GET" action="{{ route('pastEvent') }}">
                        ...
                        <div class="col-md-5 d-flex justify-content-md-end gap-2">
                            <form method="GET" action="{{ route('pastEvent') }}" class="d-flex">
                                ...
                                @else
                                    @foreach ($events as $item)
                                        <div class="col-md-4 d-flex justify-content-center" data-aos="fade-up" data-aos-delay="100">
                                            <a href="{{ route('detailDocumentation', $item->id)}}" class="text-dark text-decoration-none">
