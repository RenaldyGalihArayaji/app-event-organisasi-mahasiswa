...
@section('content')
    ...
    <div class="page-title" data-aos="fade">
        <div class="container d-lg-flex justify-content-between align-items-center">
            <h1 class="mb-2 mb-lg-0">Event Organisasi | <span class="text-secondary fs-6">{{ ucwords($organization->name)}}</span></h1>
            <nav class="breadcrumbs">
                ...
                <li class="current text-primary">Event Organisasi</li>
                </ol>
            </nav>
        </div>
    </div>
    ...
    <section id="team" class="team section">
        <div class="container section-title" data-aos="fade-up">
            <h2>Event</h2>
            <p><span>{{ ucwords($organization->name)}}</span></p>
        </div>
        <div class="container">
            <div class="row mb-4">
                <div class="col-md-12">
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <form class="d-flex" role="search" method="GET" action="{{ route('organizationEvent', $organization->id) }}">
                        ...
                        <div class="col-md-3 mb-3">
                            <form method="GET" action="{{ route('organizationEvent', $organization->id) }}" class="d-flex">
